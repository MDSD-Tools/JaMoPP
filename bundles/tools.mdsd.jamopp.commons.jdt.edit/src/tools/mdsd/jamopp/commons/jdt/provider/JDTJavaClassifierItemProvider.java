 ...
 *  
 */
package tools.mdsd.jamopp.commons.jdt.provider;
...
/**
 * This is the item provider adapter for a {@link tools.mdsd.jamopp.commons.jdt.JDTJavaClassifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JDTJavaClassifierItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCachedFieldsPropertyDescriptor(object);
			addHasCachedFieldsPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Cached Fields feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCachedFieldsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JDTJavaClassifier_cachedFields_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JDTJavaClassifier_cachedFields_feature", "_UI_JDTJavaClassifier_type"),
				 JdtPackage.Literals.JDT_JAVA_CLASSIFIER__CACHED_FIELDS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Has Cached Fields feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHasCachedFieldsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JDTJavaClassifier_hasCachedFields_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JDTJavaClassifier_hasCachedFields_feature", "_UI_JDTJavaClassifier_type"),
				 JdtPackage.Literals.JDT_JAVA_CLASSIFIER__HAS_CACHED_FIELDS,
				 true,
				 false,
				 false,
	...
	protected void addProjectNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JDTJavaClassifier_projectName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JDTJavaClassifier_projectName_feature", "_UI_JDTJavaClassifier_type"),
				 JdtPackage.Literals.JDT_JAVA_CLASSIFIER__PROJECT_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JDTJavaClassifier_abstract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JDTJavaClassifier_abstract_feature", "_UI_JDTJavaClassifier_type"),
				 JdtPackage.Literals.JDT_JAVA_CLASSIFIER__ABSTRACT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addInterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JDTJavaClassifier_interface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JDTJavaClassifier_interface_feature", "_UI_JDTJavaClassifier_type"),
				 JdtPackage.Literals.JDT_JAVA_CLASSIFIER__INTERFACE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addEnumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JDTJavaClassifier_enum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JDTJavaClassifier_enum_feature", "_UI_JDTJavaClassifier_type"),
				 JdtPackage.Literals.JDT_JAVA_CLASSIFIER__ENUM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((JDTJavaClassifier)object).getSimpleName();
