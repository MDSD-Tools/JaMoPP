...
/**
 * This is the item provider adapter for a {@link tools.mdsd.jamopp.commons.jdt.JDTField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JDTFieldItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JDTField_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JDTField_name_feature", "_UI_JDTField_type"),
				 JdtPackage.Literals.JDT_FIELD__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((JDTField)object).getName();
