...
class BindingToModuleConverter extends ToConverter<IModuleBinding, org.emftext.language.java.containers.Module> {
	...
	@Override
	org.emftext.language.java.containers.Module convert(IModuleBinding binding) {
