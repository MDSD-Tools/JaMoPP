...
public class BindingToAnnotationAttributeSettingConverter
	...
	public AnnotationAttributeSetting convert(IMemberValuePairBinding binding) {
		var result = this.annotationsFactory.createAnnotationAttributeSetting();
		result.setAttribute(this.jdtTResolverUtility.getInterfaceMethod(binding.getMethodBinding()));
		result.setValue(this.objectToAnnotationValueConverter.convert(binding.getValue()));
		return result;
	}
