...
public class ClassifierReferencePrinterImpl implements ClassifierReferencePrinterInt {

	private final AnnotablePrinterInt AnnotablePrinter;
	private final TypeArgumentablePrinterInt TypeArgumentablePrinter;

	@Inject
	public ClassifierReferencePrinterImpl(AnnotablePrinterInt annotablePrinter,
