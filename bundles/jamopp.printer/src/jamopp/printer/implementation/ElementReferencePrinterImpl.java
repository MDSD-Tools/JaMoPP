...
public class ElementReferencePrinterImpl implements ElementReferencePrinterInt {
	...
	@Inject
	public ElementReferencePrinterImpl(IdentifierReferencePrinterInt identifierReferencePrinter,
