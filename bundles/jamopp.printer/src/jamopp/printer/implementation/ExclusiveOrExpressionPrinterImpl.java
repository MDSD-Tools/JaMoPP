...
public class ExclusiveOrExpressionPrinterImpl implements ExclusiveOrExpressionPrinterInt {

	private final ExclusiveOrExpressionChildPrinterInt ExclusiveOrExpressionChildPrinter;

	@Inject
	public ExclusiveOrExpressionPrinterImpl(ExclusiveOrExpressionChildPrinterInt exclusiveOrExpressionChildPrinter) {
