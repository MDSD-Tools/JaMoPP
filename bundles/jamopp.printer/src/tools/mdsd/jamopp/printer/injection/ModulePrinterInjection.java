...
public class ModulePrinterInjection extends AbstractModule {
	...
	protected void configure() {
		...
		bind(new TypeLiteral<Printer<tools.mdsd.jamopp.model.java.classifiers.Class>>(){}).to(ClassPrinterImpl.class).in(Singleton.class);
		...
		bind(new TypeLiteral<Printer<tools.mdsd.jamopp.model.java.containers.Module>>(){}).to(ModulePrinterImpl.class).in(Singleton.class);
