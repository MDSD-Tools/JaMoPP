...
public class TypeExtension {
	...
	public static boolean isSuperType(Type me, long arrayDimension, Type otherType, ArrayTypeable otherArrayType) {
		...
		if (lOtherType instanceof tools.mdsd.jamopp.model.java.classifiers.Class) {
			PrimitiveType primitiveType = ((tools.mdsd.jamopp.model.java.classifiers.Class) lOtherType).unWrapPrimitiveType();
		...
		return (_this instanceof tools.mdsd.jamopp.model.java.types.Float ||
				_this instanceof tools.mdsd.jamopp.model.java.types.Double) && (lOtherType instanceof tools.mdsd.jamopp.model.java.types.Float ||
				lOtherType instanceof tools.mdsd.jamopp.model.java.types.Double);
	}
