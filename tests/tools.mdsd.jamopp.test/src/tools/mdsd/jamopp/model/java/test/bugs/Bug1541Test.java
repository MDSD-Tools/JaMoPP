...
public class Bug1541Test extends AbstractBugTestCase {
    ...
    public void testPrinting() throws IOException {
        ...
        final Class classA = ClassifiersFactory.eINSTANCE.createClass();
        cu.getClassifiers()
            .add(classA);
        ...
        final ClassMethod m1 = MembersFactory.eINSTANCE.createClassMethod();
        m1.setName("m1");
        ...
        final Block cont = StatementsFactory.eINSTANCE.createBlock();
        cont.setName("");
        ...
        final Resource r = createResourceSet().createResource(URI.createURI("ClassA.java"));
        ...
        assertTrue(out.toString()
            .matches( // \\u003b is ; \\u007b is { \\u007d is }
                    "package\\s++org\\.my\\.namespace1\\u003b\\s++class\\s++ClassA\\s++\\u007b"
                            + "\\s++public\\s++void\\s++m1\\(\\)\\s++\\u007b" + "\\s++return\\u003b" + "\\s++\\u007d"
                            + "\\s++\\u007d\\s++"));
    }
}
