...
public class JaMoPPJDTParserTest {
	...
	private void jdtParser(final Path caseStudy) {
	...
	public void testCommons() {
		assertDoesNotThrow(() -> jdtParser(
				Path.of("./resources/commons-lang-rel-commons-lang-3.12.0").toAbsolutePath().normalize()));
	}
	...
	public void testDependencyTool() {
		assertDoesNotThrow(() -> jdtParser(
				Path.of("./resources/Palladio-Build-DependencyTool-master").toAbsolutePath().normalize()));
	}
	...
	public void testEventuate() {
		assertDoesNotThrow(() -> jdtParser(Path.of(
	...
	public void testH2database() {
		assertDoesNotThrow(
				() -> jdtParser(Path.of("./resources/h2database-version-2.1.210").toAbsolutePath().normalize()));
	}

	@Test
	public void testKafka() {
		assertDoesNotThrow(
				() -> jdtParser(Path.of("./resources/microservice-kafka-master").toAbsolutePath().normalize()));
	}
	...
	public void testPetclinic() {
		assertDoesNotThrow(() -> jdtParser(
				Path.of("./resources/spring-petclinic-microservices-2.3.6").toAbsolutePath().normalize()));
	}
	...
	/**
	 * Test is broken. It suddenly stopped working without any changes.
	 */
	@Test
	@Disabled
	...
	public void testTimeSheetGenerator() {
		assertDoesNotThrow(
				() -> jdtParser(Path.of("./resources/TimeSheetGenerator-main").toAbsolutePath().normalize()));
	}
	...
	public void testWebsockets() {
		assertDoesNotThrow(
				() -> jdtParser(Path.of("./resources/smart-home-websockets-master").toAbsolutePath().normalize()));
	}
}
